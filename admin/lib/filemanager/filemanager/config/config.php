...
$_IS_FILEMANAGER = true;
require_once dirname(dirname(dirname(dirname(dirname(dirname(__FILE__)))))).'/lib/init.php';
...
$config = array(
	...
	*******************/
	...
	'fixed_image_creation_height'             => array(), //height of image (you can leave empty if you set width)
	/*
	#             $option:     0 / exact = defined size;
	#                          1 / portrait = keep aspect set height;
	#                          2 / landscape = keep aspect set width;
	...
	#                          4 / crop= resize and crop;
	*/
	'fixed_image_creation_option'             => array( 'auto', 'auto', 'crop' ), //set the type of the crop
